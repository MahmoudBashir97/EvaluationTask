 ...
 */
public class Meats_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_meats_fragment, container, false);
        ...
        Observer<List<categories>> listObserver=new Observer<List<categories>>() {
            ...
            public void onNext(List<categories> models) {
                productsList=models.get(2).getProducts();
